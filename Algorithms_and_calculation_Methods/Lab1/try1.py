    ...
    def show_linear(e):
        ...
        def calculate(e):
            try:
                ...
                result.value = f"Помилка: {err}--> Неправельно введені дані, переконайтеся, що не відбувається ділення на нуль чи під кореневий вираз менше за '0'"
            page.update()
    ...
    def show_cyclic(e):
        ...
        def calculate(e):
            try:
                ...
                # while a_val <= n_val:
                #     for b_val in range(1, n_val + 1):
                #         numerator = a_val ** 4 + b_val ** 4
                #         denominator = a_val ** 4 - b_val ** 4
                #         if denominator == 0:
                #             continue
