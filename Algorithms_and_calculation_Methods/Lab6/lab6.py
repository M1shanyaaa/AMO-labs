class TuringMachine:
    ...
    def create_transition_table(self):
        ...
        table[("q0", "#")] = (
            ...
            "#",
            "L",
        )  # Знайшли кінець, повертаємось до останньої цифри
        ...
        table[("q1", " ")] = (
            ...
            " ",
            "L",
        )  # Перейшли до роздільника, далі будемо опрацьовувати перше число
        ...
        table[("q8", None)] = (
            ...
            None,
            "R",
        )  # Дійшли до початку стрічки, почнемо чистку
        ...
        table[("q10", " ")] = (
            ...
            " ",
            "L",
        )  # ДОДАНО: досягли початку числа, обробка від'ємного результату
        table[("q10", None)] = (
            "q14",
            None,
            "R",
        )  # ДОДАНО: обробка від'ємного результату
        ...
        table[("q11", " ")] = (
            ...
            " ",
            "R",
        )  # Знайшли пробіл, переходимо до видалення другого числа
        ...
        table[("q13", "#")] = (
            ...
            " ",
            "L",
        )  # ДОДАНО: видалення маркера, якщо він залишився
    ...
    def step(self):
        ...
        if (self.state, current_symbol) in self.transition_table:
            new_state, new_symbol, move_direction = self.transition_table[
            ...
            print(
                f"Помилка: немає переходу для стану {self.state} і символу {current_symbol}"
            )
            return False
    ...
    def run(self, debug=False):
        ...
        while self.state != self.final_state:
            ...
            if steps > 10000:
                print(
                    "Перевищено максимальну кількість кроків. Можливо, машина зациклилась."
                )
                break
...
def subtract_in_base6(x, y, debug=False):
    ...
    for digit in x + y:
        if digit not in "012345":
            raise ValueError(
                f"Невірний символ '{digit}'. Вхідні числа повинні містити лише цифри 0-5."
            )
    ...
    if x_decimal >= y_decimal:
        ...
        if debug:
            print(
                f"Перевірка: {x}₆ - {y}₆ = {expected_base6}₆ ({x_decimal}₁₀ - {y_decimal}₁₀ = {expected}₁₀)"
            )
    else:
        if debug:
            print(
                f"Попередження: X ({x}₆ = {x_decimal}₁₀) менше ніж Y ({y}₆ = {y_decimal}₁₀)."
            )
            print(
                "Результат буде встановлено у 0, оскільки машина не підтримує від'ємні числа."
            )
